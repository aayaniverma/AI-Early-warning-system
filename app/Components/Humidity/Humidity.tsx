...
function Humidity() {
  ...
  return (
    <div className="pt-6 pb-5 px-4 h-[12rem] border rounded-lg flex flex-col gap-8 bg-green-200 shadow-sm dark:shadow-none">
      <div className="top">
        <h2 className="flex items-center gap-2 font-medium text-blue-800">
          {droplets} Humidity
        </h2>
        <p className="pt-4 text-2xl text-blue-800">{humidity}%</p>
      </div>

      <p className="text-sm text-blue-800">{getHumidityText(humidity)}.</p>
    </div>
  );
}
