...
function AirPollution() {
  ...
  return (
    <div
      ...
      bg-green-200 shadow-sm dark:shadow-none col-span-full sm-2:col-span-2 md:col-span-2 xl:col-span-2"
    >
      <h2 className="flex items-center gap-2 font-medium text-blue-800">
        {thermo}Air Pollusion
      </h2>
      <Progress value={airQualityIndex} max={100} className="progress" />
      <p className="text-sm text-blue-800">Air quality is {filteredIndex?.description}. </p>
    </div>
  );
}
